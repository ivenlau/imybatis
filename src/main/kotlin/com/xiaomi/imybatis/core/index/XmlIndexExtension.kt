...
/**
 * Index extension for Mapper XML files
 */
class XmlIndexExtension : ScalarIndexExtension<String>() {
    override fun getName(): ID<String, Void?> = XmlIndex.NAME
    ...
    override fun getInputFilter(): InputFilter {
        return InputFilter { file -> file.fileType == XmlFileType.INSTANCE }
    }
